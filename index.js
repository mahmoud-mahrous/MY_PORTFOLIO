...
let typed = new Typed('.auto-typed',{
 ...
 projectsImgs =  document.getElementsByClassName("blog-wrapper-img");
 console.log(projectsImgs[0].nextElementSibling.getAttribute("href"));


for (const img of projectsImgs) {
    console.log(img);
    img.addEventListener("click",()=>{
        projectLink =  img.nextElementSibling.getAttribute("href");
